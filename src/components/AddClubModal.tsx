      ...
      <div className="bg-surface-raised border border-white/8 rounded-2xl w-full max-w-sm p-5 flex flex-col gap-4">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          >
            ...
            <span
              className={`text-xs font-semibold text-white/60 ${rank ? "hidden" : ""}`}
              style={{ display: rank ? "none" : undefined }}
            >
            ...
            {!rank && (
              <>
                ...
                <span className="text-[10px] text-white/20 group-hover:text-white/35 tracking-wider uppercase transition-colors">Rank</span>
              </>
            )}
            {rank && (
            ...
            <div className="grid grid-cols-4 gap-2">
              ...
              {RANKS.map((r) => (
                ...
                >
                  ...
                  />
                  <span className="text-[9px] text-white/30 hidden">{displayRank(r)}</span>
